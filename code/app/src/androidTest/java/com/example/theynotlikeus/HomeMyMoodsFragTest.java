...
public class HomeMyMoodsFragTest {
    ...
    public void appShouldDisplayExistingMoviesOnLaunch() throws InterruptedException {
        ...
        // Click on "CONFUSION" mood event
        onView(withText("CONFUSION")).perform(click());


        // Check
        // Check that the movie details are displayed correctly
        // Find a way to check the correct drawable
        //onView(withId(R.id.imageview_ActivityMoodEventDetails_moodimage)).check(matches(withDrawable(R.drawable)));
    }

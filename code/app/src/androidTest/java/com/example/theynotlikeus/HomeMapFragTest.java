...
public class HomeMapFragTest {
    ...
    public static void setup() throws InterruptedException {
        // Remove the emulator configuration call below because
        // the CustomTestRunner already sets Firestore to use the emulator.
    ...
    public void testMapFragmentIsDisplayed() throws InterruptedException {
        // The ActivityScenarioRule already launches MainActivity.

        // Click on the bottom navigation item for the map.
